    ...
    <>
      <section className="bg-gradient-to-br from-cyan-600 to-blue-700 text-white py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-5xl font-extrabold leading-tight">Slimme Technologie</h1>
          <p className="mt-3 sm:mt-4 text-base sm:text-lg text-cyan-100 max-w-2xl">
            De bouwstenen van intelligente energiestuur: P1-meter, HEMS en Home Assistant. Leer hoe je je huishouden optimaal bestuurt.
          </p>
        </div>
      </section>
